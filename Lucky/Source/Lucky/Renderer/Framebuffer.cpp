...
namespace Lucky
{
    ...
    void Framebuffer::Invalidate()
    {
        ...
        {
            LC_CORE_ASSERT(m_ColorAttachments.size() <= 4, "m_ColorAttachments.size() > 4");    // 颜色缓冲区不超过 4
        ...
        // 检查帧缓冲区状态
        LC_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete！");
