...
namespace Lucky
{
    ...
    */
    ...
    public:
        ...
        template<typename Func>
        inline static void ImageButton(const std::string& label, uint32_t textureID, const glm::vec2& size, Func OnSelected, float framePadding = 2.0f, float labelMinWidth = 120.0f, float widgetOffset = 40.0f);
    ...
    template<typename Func>
    inline void GUI::ImageButton(const std::string& label, uint32_t textureID, const glm::vec2& size, Func OnSelected, float framePadding, float labelMinWidth, float widgetOffset)
    {
        ImGui::PushID(label.c_str());   // 设置控件 ID
    ...
    inline void GUI::ObjectField(const std::string& label, uint32_t textureID, const std::string& objectName, Func OnClicked, float labelMinWidth, float widgetOffset)
    {
        ...
        // TODO
        //ImGui::Image((ImTextureID)textureID, ImVec2(20, 20), ImVec2(0, 1), ImVec2(1, 0));
